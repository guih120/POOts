...
const userList = app.listUsers();
console.log("Lista de Usuários:", userList);
const rentList = app.listRents();
console.log("Lista de Reservas/Aluguéis:", rentList);
const bikeList = app.listBikes();
console.log("Lista de Bicicletas:", bikeList);
